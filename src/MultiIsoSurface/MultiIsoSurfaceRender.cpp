...
public:
    ...
    void SetIsoValueAndColor(double iso_value1,const std::array<double,4>& color1,
...
MultiIsoSurfaceRenderImpl::MultiIsoSurfaceRenderImpl(int w, int h)
...
void MultiIsoSurfaceRender::SetIsoValueAndColor(double iso_value1, const std::array<double, 4> &color1, double iso_value2,
