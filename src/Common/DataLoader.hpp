...
template<class Ty>
void LoadRawVolumeData(const char* file_name,ScalarFieldData& scalar_field_data) noexcept(false) {
...
void LoadRawVolumeData(const char* file_name,ScalarFieldData& scalar_field_data){
    switch (scalar_field_data.type) {
        case ScalarFieldDataType::UInt8: LoadRawVolumeData<uint8_t>(file_name,scalar_field_data);break;
        case ScalarFieldDataType::Int8: LoadRawVolumeData<int8_t>(file_name,scalar_field_data);break;
        case ScalarFieldDataType::UInt16: LoadRawVolumeData<uint16_t>(file_name,scalar_field_data);break;
        case ScalarFieldDataType::Int16: LoadRawVolumeData<int16_t>(file_name,scalar_field_data);break;
        case ScalarFieldDataType::UInt32: LoadRawVolumeData<uint32_t>(file_name,scalar_field_data);break;
        case ScalarFieldDataType::Int32: LoadRawVolumeData<int32_t>(file_name,scalar_field_data);break;
        case ScalarFieldDataType::Float32: LoadRawVolumeData<float>(file_name,scalar_field_data);break;
        case ScalarFieldDataType::Float64: LoadRawVolumeData<double>(file_name,scalar_field_data);break;
        case ScalarFieldDataType::Unknown: break;
    }
