...
public:
    ...
    TrackBall(float radius, int screen_w, int screen_h) : radius(radius), screen_width(screen_w),
                                                          screen_height(screen_h),
                                                          half_screen_w(0.5f * screen_w),
                                                          half_screen_h(0.5f * screen_h), mode(ARC),
                                                          ratio(screen_h*0.5f/radius)
                                                          {}
...
inline void
TrackBallCamera::processMouseButton(CameraDefinedMouseButton button, bool press, double x_pos, double y_pos) {
